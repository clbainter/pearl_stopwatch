...
import 'package:pearl_stopwatch/screens/stopwatch/src/ui/widgets/stopwatch_buttons_lg.dart';

void main() {
  group('StopwatchButtonsLg Tests', () {
    tearDown(() {
      FakeAsync().flushMicrotasks();
    });
    testWidgets('StopwatchButtonsLg', (widgetTester) async {
