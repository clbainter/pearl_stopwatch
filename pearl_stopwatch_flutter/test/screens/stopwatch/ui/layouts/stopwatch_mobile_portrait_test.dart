...
import 'package:pearl_stopwatch/screens/stopwatch/src/ui/layouts/stopwatch_mobile_portrait.dart';
import 'package:pearl_stopwatch/screens/stopwatch/src/ui/stopwatch_strings.dart';

void main() {
  group('StopwatchMobilePortrait Tests', () {
    tearDown(() {
      FakeAsync().flushMicrotasks();
    });
    testWidgets('StopwatchMobilePortrait', (widgetTester) async {
