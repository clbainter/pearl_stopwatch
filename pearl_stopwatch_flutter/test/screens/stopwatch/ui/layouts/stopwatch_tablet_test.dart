...
import 'package:pearl_stopwatch/screens/stopwatch/src/ui/layouts/stopwatch_tablet.dart';
import 'package:pearl_stopwatch/screens/stopwatch/src/ui/stopwatch_strings.dart';

void main() {
  group('StopwatchTablet Tests', () {
    tearDown(() {
      FakeAsync().flushMicrotasks();
    });
    testWidgets('StopwatchTablet', (widgetTester) async {
